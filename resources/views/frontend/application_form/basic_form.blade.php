...
@section('frontend_content')
    ...
    <div class="container" id="personalInfoForm">
        <form method="POST" action="{{ route('basic.info') }}">
                 ...
                 <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="division_id"><span style="color: red">*</span></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="district_id"><span style="color: red">*</span></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="upazila_id"><span style="color: red">*</span></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="union_id"><span style="color: red">*</span></label>
            ...
            <div class="col-md-6">
                <button type="submit" class="btn btn-primary mt-3" id="next">Next</button>
            </div>
        </form>
    </div>
</section><!-- End Hero -->
